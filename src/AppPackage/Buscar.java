...
public class Buscar extends javax.swing.JDialog {
    ...
    void acceder (String sqlSearch)
    {
        String sql = "Select * from usuarios where nombre_usuario = '" + jTextField1.getText() + "'";
        try {
            Statement st = con.createStatement();
            ResultSet rs = st.executeQuery(sql);
            while (rs.next())
            {
                jLabel1.setText(rs.getString("palabra_clave"));
            }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String sqlBusqueda;
        sqlBusqueda = jTextField1.getText();
        acceder(sqlBusqueda);
